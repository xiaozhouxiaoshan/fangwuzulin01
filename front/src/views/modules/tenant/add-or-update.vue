      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="姓名" prop="fullName">
          <el-input v-model="ruleForm.fullName" 
              placeholder="姓名" clearable  :readonly="ro.fullName"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="姓名" prop="fullName">
              <el-input v-model="ruleForm.fullName" 
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.avatar" label="头像" prop="avatar">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.avatar.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.gender"
                placeholder="性别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="职业" prop="occupation">
          <el-input v-model="ruleForm.occupation" 
              placeholder="职业" clearable  :readonly="ro.occupation"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="职业" prop="occupation">
              <el-input v-model="ruleForm.occupation" 
          ...
          <el-form-item class="input" label="联系电话" prop="contactPhone">
              <el-input v-model="ruleForm.contactPhone" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="身份证" prop="idCardNumber">
          <el-input v-model="ruleForm.idCardNumber" 
              placeholder="身份证" clearable  :readonly="ro.idCardNumber"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="身份证" prop="idCardNumber">
              <el-input v-model="ruleForm.idCardNumber" 
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gender = true;
            continue;
	            	            ...
	            	            if(o=='occupation'){
            this.ruleForm.occupation = obj[o];
	    this.ro.occupation = true;
            continue;
          }
	            	            if(o=='contactPhone'){
	    ...
	    this.ro.contactPhone = true;
            continue;
	            	            ...
	            	            if(o=='idCardNumber'){
            this.ruleForm.idCardNumber = obj[o];
	    this.ro.idCardNumber = true;
            continue;
          }
	                    }
                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tenant/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tenantCrossAddOrUpdateFlag = false;
                  this.parent.search();
