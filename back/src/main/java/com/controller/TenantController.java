...
public class TenantController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		String token = tokenService.generateToken(user.getId(), username,"tenant",  "用户" );
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        TenantEntity user = tenantService.selectById(id);
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,TenantEntity tenant, HttpServletRequest request){
        EntityWrapper<TenantEntity> ew = new EntityWrapper<TenantEntity>();
		PageUtils page = tenantService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, tenant), params), params));
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,TenantEntity tenant, HttpServletRequest request){
        EntityWrapper<TenantEntity> ew = new EntityWrapper<TenantEntity>();
		PageUtils page = tenantService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, tenant), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R query(TenantEntity tenant){
		...
		return R.ok("查询用户成功").put("data", tenantView);
    }
    ...
    public R update(@RequestBody TenantEntity tenant, HttpServletRequest request){
        //ValidatorUtils.validateEntity(tenant);
        tenantService.updateById(tenant);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<TenantEntity> wrapper = new EntityWrapper<TenantEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = tenantService.selectCount(wrapper);
