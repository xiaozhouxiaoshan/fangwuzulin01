...
INSERT INTO `houseListingComment` (`id`, `addtime`, `refid`, `userid`, `content`, `reply`) VALUES
...
INSERT INTO `landlordApplicationComment` (`id`, `addtime`, `refid`, `userid`, `content`, `reply`) VALUES
...
CREATE TABLE IF NOT EXISTS `houseRepair` (
  ...
  `landlordzhanghao` varchar(200) DEFAULT NULL COMMENT '房主账号',
  `landlordxingming` varchar(200) DEFAULT NULL COMMENT '房主姓名',
  `tenantming` varchar(200) DEFAULT NULL COMMENT '用户名',
...
INSERT INTO `houseRepair` (`id`, `addtime`, `hetongbianhao`, `fangwumingcheng`, `houseType`, `xiaoqu`, `baoxiumingcheng`, `leixing`, `baoxiuneirong`, `tupian`, `baoxiuriqi`, `landlordzhanghao`, `landlordxingming`, `tenantming`, `lianxidianhua`, `sfsh`, `shhf`) VALUES
...
INSERT INTO `houseType` (`id`, `addtime`, `houseType`) VALUES
...
INSERT INTO `houseReview` (`id`, `addtime`, `hetongbianhao`, `fangwumingcheng`, `houseType`, `xiaoqu`, `pingfen`, `pingjianeirong`, `pingjiariqi`, `landlordzhanghao`, `tenantming`, `lianxidianhua`, `sfsh`, `shhf`) VALUES
...
INSERT INTO `houseListing` (`id`, `addtime`, `fangwumingcheng`, `houseType`, `tupian`, `zulinfangshi`, `chaoxianglouceng`, `mianji`, `fangwuzhuangtai`, `xiaoqu`, `xiangxidizhi`, `yuezujiage`, `yajin`, `fangwusheshi`, `fangwuxiangqing`, `faburiqi`, `landlordzhanghao`, `landlordxingming`) VALUES
...
CREATE TABLE IF NOT EXISTS `landlord` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `landlordzhanghao` varchar(200) NOT NULL COMMENT '房主账号',
  `mima` varchar(200) NOT NULL COMMENT '密码',
  `landlordxingming` varchar(200) NOT NULL COMMENT '房主姓名',
  `xingbie` varchar(200) DEFAULT NULL COMMENT '性别',
  `touxiang` varchar(200) DEFAULT NULL COMMENT '头像',
  `shouji` varchar(200) DEFAULT NULL COMMENT '手机',
  `shenfenzheng` varchar(200) DEFAULT NULL COMMENT '身份证',
  PRIMARY KEY (`id`),
  UNIQUE KEY `landlordzhanghao` (`landlordzhanghao`)
) ENGINE=InnoDB AUTO_INCREMENT=1614855337501 DEFAULT CHARSET=utf8mb3 COMMENT='房主';

DELETE FROM `landlord`;
INSERT INTO `landlord` (`id`, `addtime`, `landlordzhanghao`, `mima`, `landlordxingming`, `xingbie`, `touxiang`, `shouji`, `shenfenzheng`) VALUES
	(21, '2021-03-04 10:46:53', 'landlord_zhang', '123456', '张明', '男', 'http://localhost:8080/zhihuifangwuzulin/upload/landlord_touxiang1.jpg', '13823888881', '440300199101010001'),
	(22, '2021-03-04 10:46:53', 'landlord_li', '123456', '李娜', '女', 'http://localhost:8080/zhihuifangwuzulin/upload/landlord_touxiang2.jpg', '13823888882', '440300199202020002'),
	(23, '2021-03-04 10:46:53', 'landlord_wang', '123456', '王强', '男', 'http://localhost:8080/zhihuifangwuzulin/upload/landlord_touxiang3.jpg', '13823888883', '440300199303030003'),
	(24, '2021-03-04 10:46:53', 'landlord_zhao', '123456', '赵敏', '女', 'http://localhost:8080/zhihuifangwuzulin/upload/landlord_touxiang4.jpg', '13823888884', '440300199404040004'),
	(25, '2021-03-04 10:46:53', 'landlord_chen', '123456', '陈凯', '男', 'http://localhost:8080/zhihuifangwuzulin/upload/landlord_touxiang5.jpg', '13823888885', '440300199505050005'),
	(26, '2021-03-04 10:46:53', 'landlord_sun', '123456', '孙悦', '女', 'http://localhost:8080/zhihuifangwuzulin/upload/landlord_touxiang6.jpg', '13823888886', '440300199606060006'),
...
INSERT INTO `rentalContract` (`id`, `addtime`, `hetongbianhao`, `fangwumingcheng`, `houseType`, `xiaoqu`, `yuezujiage`, `zuyongyueshu`, `zuyongjine`, `yajin`, `fangzuzhuangtai`, `hetongjine`, `hetongneirong`, `shengxiaori`, `youxianqizhi`, `tenantming`, `lianxidianhua`, `landlordzhanghao`, `landlordxingming`, `sfsh`, `shhf`, `ispay`) VALUES
...
INSERT INTO `messageBoard` (`id`, `addtime`, `userid`, `username`, `content`, `reply`) VALUES
...
INSERT INTO `announcement` (`id`, `addtime`, `title`, `introduction`, `picture`, `content`) VALUES
...
INSERT INTO `favorite` (`id`, `addtime`, `userid`, `refid`, `tablename`, `name`, `picture`) VALUES
...
INSERT INTO `adminUser` (`id`, `username`, `password`, `role`, `addtime`) VALUES
...
INSERT INTO `repairHandling` (`id`, `addtime`, `fangwumingcheng`, `houseType`, `baoxiumingcheng`, `leixing`, `baoxiuriqi`, `weixiufankui`, `weixiujindu`, `gengxinriqi`, `landlordzhanghao`, `landlordxingming`, `tenantming`, `lianxidianhua`) VALUES
...
INSERT INTO `landlordApplication` (`id`, `addtime`, `fangwumingcheng`, `houseType`, `tupian`, `zulinfangshi`, `chaoxianglouceng`, `xiaoqu`, `mianji`, `yuezujiage`, `fangwuxiangqing`, `faburiqi`, `tenantming`, `lianxidianhua`, `sfsh`, `shhf`) VALUES
...
CREATE TABLE IF NOT EXISTS `tenant` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `tenantming` varchar(200) NOT NULL COMMENT '用户名',
  `mima` varchar(200) NOT NULL COMMENT '密码',
  ...
  `shenfenzheng` varchar(200) DEFAULT NULL COMMENT '身份证',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tenantming` (`tenantming`)
) ENGINE=InnoDB AUTO_INCREMENT=1614855579739 DEFAULT CHARSET=utf8mb3 COMMENT='用户';

DELETE FROM `tenant`;
INSERT INTO `tenant` (`id`, `addtime`, `tenantming`, `mima`, `xingming`, `touxiang`, `xingbie`, `zhiye`, `lianxidianhua`, `shenfenzheng`) VALUES
	(11, '2021-03-04 10:46:53', 'tenant_lin', '123456', '林雨桐', 'http://localhost:8080/zhihuifangwuzulin/upload/tenant_touxiang1.jpg', '女', '产品经理', '13900010001', '440300199101010001'),
	(12, '2021-03-04 10:46:53', 'tenant_zhou', '123456', '周子轩', 'http://localhost:8080/zhihuifangwuzulin/upload/tenant_touxiang2.jpg', '男', '软件工程师', '13900010002', '440300199202020002'),
	(13, '2021-03-04 10:46:53', 'tenant_he', '123456', '何晨曦', 'http://localhost:8080/zhihuifangwuzulin/upload/tenant_touxiang3.jpg', '男', '设计师', '13900010003', '440300199303030003'),
	(14, '2021-03-04 10:46:53', 'tenant_wu', '123456', '吴思远', 'http://localhost:8080/zhihuifangwuzulin/upload/tenant_touxiang4.jpg', '男', '财务专员', '13900010004', '440300199404040004'),
	(15, '2021-03-04 10:46:53', 'tenant_ma', '123456', '马可欣', 'http://localhost:8080/zhihuifangwuzulin/upload/tenant_touxiang5.jpg', '女', '教师', '13900010005', '440300199505050005'),
	(16, '2021-03-04 10:46:53', 'tenant_qian', '123456', '钱嘉乐', 'http://localhost:8080/zhihuifangwuzulin/upload/tenant_touxiang6.jpg', '男', '医生', '13900010006', '440300199606060006'),
...
INSERT INTO `viewingAppointment` (`id`, `addtime`, `yuyuebianhao`, `fangwumingcheng`, `houseType`, `fangwuzhuangtai`, `xiaoqu`, `yuezujiage`, `yajin`, `zuyongyueshu`, `zuyongjine`, `yuyueshijian`, `tenantming`, `xingming`, `shenfenzheng`, `lianxidianhua`, `landlordzhanghao`, `landlordxingming`, `sfsh`, `shhf`) VALUES
